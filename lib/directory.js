var
  ...
  debug        = require('debug')('loaddir:directory'),
  Directory
  ;
...
Directory = function(options) {
  ...
  debug('Directory'.yellow, 'constructor'.blue, self.path.green);
...
Directory.prototype._watchHandler = function(){
  ...
  debug('Directory'.yellow, '_watchHandler'.blue, this.options.path.green);
