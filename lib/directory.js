...
Directory.prototype.load = function() {
  ...
  if (!this.path) console.log('loaddir: undefined path'.red, this);
...
Directory.prototype._watchHandler = function(type, fName){

  if (_.include(this.watchedPaths, join(this.options.path, fName))) return;
  debugBase('loaddir:watch')('Directory'.yellow, '_watchHandler'.blue, this.options.path.green, arguments);
