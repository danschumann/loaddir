...
Directory.prototype.exclude = function(fileName, path) {
  ...
  var self = this;
  debug(' Directory exclude.  Already exists on output '.red,
      !self.asObject && self.output[path],
      self.asObject && self.output[fileName],
      fileName, path);

  // exists -- NOTE: I don't remember if this actually happens or why
...
Directory.prototype.buildManifest = function(manifest){
  ...
  _.each(self.children, function(child) {
    ...
    manifest[child.path] = (function(){
      //console.log('HAHAHDFHDSAJKFLALSDKJASLDKJsdfljasdfkljasldffsdHAHAHDFHDSAJKFLALSDKJASLDKJsdfljasdfkljasldffsdHAHAHDFHDSAJKFLALSDKJASLDKJsdfljasdfkljasldffsdlllHAHAHDFHDSAJKFLALSDKJASLDKJsdfljasdfkljasldffsdl'.red, child);
