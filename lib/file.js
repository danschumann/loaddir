...
File.prototype.load = function() {
  ...
  .then(function(){
    ...
    console.log('Error loading file -- stack'.red, self.path.blue, er, er.stack);
...
File.prototype.readFile = function(){
  ...
  .otherwise(function(er) {
    ...
    console.log('Error reading file'.red, er, er.stack)
...
File.prototype._watchHandler = function() {
  ...
  var self = this;
  debugBase('loaddir:watch')('File'.magenta, 'watchHandler'.blue, this.path.green, arguments);
